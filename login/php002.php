    ...
    <center>
        ...
        <body>
            ...
            <div style="border: 2px dashed #000000; overflow: auto; width: 450px; height: auto; text-align: center;">
                ...
                <p style="text-align:center;">$y = $x + 6;</p>
                </p>
            ...
            <div style="border: 2px dashed #000000; overflow: auto; width: 450px; height: auto; text-align: center;">
                <br><br>
                <p style="text-align:center;">$myNumber = 8;  // valid</p>
                <p style="text-align:center;">$my_number = 10.2;  // valid</p>
                <p style="text-align:center;">$_temp = 0; // valid</p>
                <p style="text-align:center;">$score3 = 50;   // valid</p>
                <br>
                <p style="text-align:center;">$11name = "M";  // not valid, start with number</p>
                <p style="text-align:center;">$a.b = true;    // not valid, contain dot</p>
            </div>
            <br>
